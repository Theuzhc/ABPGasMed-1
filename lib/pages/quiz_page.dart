...
import 'package:abpgasmed/services/save_answers.dart';
...
class _QuizPageState extends State<QuizPage> {
              ...
              setState(() {
                ...
                if (_answers.length < _controller.questionsNumber) {
                  ...
                  for (int i = 0; i < _answers.length; i++) {
                    if (_answers[i] == 'Sim') ++acertos;
                    if (_answers[i] == 'Não se Aplica') ++na;
                  }
                  FinishDialog.show(context,
                      corrects: acertos,
                      aplicable: _answers.length - na,
  ...
  void _saveAnswers() async {
    // _answers.forEach((key, value) async {
    //   final unique = Answered(answer:_answers[key] , id: key );
    //   // _controller_questions.answer;
    //   await Answered.insertAnswer(unique);
    // });
  }
}
